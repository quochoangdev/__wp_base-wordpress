 ...
 * @param string $args['ids_data']['id_select_product_sort']
 */
...
<form method="GET" class="w-full">
    <div class="relative">
        <select id="<?= $ids_data['id_select_product_sort'] ?>" name="orderby" class="appearance-none border border-[#B6B6B6] rounded-[35px] py-2 md:py-[10px] pl-6 pr-10 w-full outline-none">
