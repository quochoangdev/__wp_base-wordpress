...
<li <?php wc_product_class('custom-product-item col-span-12 lg:col-span-3 group transition-all duration-300 relative flex flex-col bg-white'); ?>>
    ...
    <div class="px-2 lg:px-4 py-2 lg:py-3 flex flex-col gap-2 flex-grow">
        <?php
        /**
