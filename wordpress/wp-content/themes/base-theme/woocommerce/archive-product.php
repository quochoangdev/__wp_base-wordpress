...
<section class="">
  ...
  <?php echo do_shortcode('[custom_checkbox_product_cat id_render_ajax="search-id-render-ajax-1" id_checkbox_product_cat="category-id-select-product-cat-1" taxonomy="product_brand" cs-query-param="product_brand"]'); ?>
