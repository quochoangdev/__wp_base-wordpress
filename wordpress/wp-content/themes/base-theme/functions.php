...
// require_once get_template_directory() . '/inc/shortcodes/sc_select-product-sort.php';
require_once get_template_directory() . '/inc/shortcodes/sc_checkbox-product-option.php';
?>
